...
# Run the Groovy script to create the user
echo "Running Groovy script to create user"
java -jar /home/ubuntu/jenkins-cli.jar -auth admin:admin -s http://localhost:8080/ groovy = /var/lib/jenkins/jenkins-setup.groovy
